    ...
    <div class="container">
        <div class="d-flex flex-wrap justify-content-between align-items-start r-g-10">
            <div class="logo-area d-flex align-items-center g-4">
                <img src="{{ asset('assets') }}/img/logo.png" alt="Site Logo" class="site-logo" style="    height: 28px;
}">
                <p>The reliable way to trade.</p>
            </div>
        ...
        <div class="footer-nav d-flex flex-wrap justify-content-between r-g-15">
            ...
            <dl>
                ...
                <dl>
                    ...
                    <dt class="text-end"><a href="{{ route('login') }}">Create An Account</a></dt>
        ...
        <div class="footer-bottom-text">
            <div></div>
            <p class="footer-text text-center">© 2024 Only - Brokerage. All Rights Reserved.</p>
            <div></div>
        </div>
    ...
    <div class="footer-bottom">
        <div class="container">
         ...
         <p>CFDs and financial spread trading are complex instruments that involve leverage, which can lead to rapid losses. Currently, 83.5% of retail investor accounts lose money trading CFDs with this provider. Before engaging in spread trading, carefully consider if you fully understand these instruments and are prepared to accept the high risk of loss. Note that CFDs do not grant ownership or interest in the underlying asset.</p>
           <p>Please be aware that the content on this website is for informational purposes only and is not tailored to your individual financial objectives, situation, or needs. Consider this information in light of your personal circumstances.
        </p>
           <p>Additionally, the value of shares, ETFs, and ETCs purchased through an Only-Brokerage share trading account can fluctuate, potentially resulting in returns lower than your initial investment. Past performance does not guarantee future outcomes.</p>
           <p>This website is operated by Only-Brokerage Europe Ltd., located at Level 12, 234 Arch. Makariou III Avenue, Nicosia, Cyprus 1065. CySEC License No. 876543.</p>
